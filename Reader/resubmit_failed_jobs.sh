...
error_dir="/afs/cern.ch/work/s/savarghe/NewJEC/2018/ele/A/LowMass2/ExcTight/log"

# Directory containing JDL files
jdl_dir="./condor2018mu_topPtlowmass"
...
batch_name="ResubmittedJobsBatchExcTight2018"
