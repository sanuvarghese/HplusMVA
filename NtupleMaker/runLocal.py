...
def execute_job(executable, arguments, output, error):
    ...
    """
    # Set up environment (example for CMSSW)
    setup_env = "source /cvmfs/cms.cern.ch/cmsset_default.sh;"

    # Build the command
    command = f"{setup_env} ./{executable} {arguments}"
...
if __name__ == "__main__":
    jdl_directory = "condor_2018_topPteleA"  # Directory containing .jdl files
