...
common_dir = "/afs/cern.ch/work/s/savarghe/private/NewJEC/Ntuple/ele/2017"
...
processes = [
    ...
    "singleTop", "Wjets", "DYjets", "VBFusion", "MCQCDEle", "MCQCDEle",
...
#     "singpiecalup",
#    "singpihcalup", #"absmpfbdown", "absscldown", "absstatdown",
...
#     "relpthfdown", "relstatecdown", "relstatfsrdown", "relstathfdown", "singpiecaldown",
 #   "singpihcaldown",
#      "jerup" , "jerdown"
]
...
argument_scenarios = [
    ...
    # "eleEff_do", "eleEff_up", "bc_stat_up", "bc_stat_do", "bc_lheelef_do", "bc_lheelef_up", "lheeler_up",
    # "lheeler_do", "isr_up", "isr_do", "fsr_up", "fsr_do", "xdyb_up", "xdyb_do", "xdyc_up",
...
channel = "ele"
region = "A"
jdl_directory = "./condor_2017_base_" + channel + region
