void PreAna_sys(TString process, TString sys) {
  ...
  TFile *inputFilebase = TFile::Open("/eos/user/i/idas/Output/cms-hcs-run2/CBA_trigSF/pre/2016/all/all_"+process+".root");
  //  TString sys = jecdown;                                                                                                                 
  ...
  TChain *ttbar= new TChain("Kinfit_Reco");
   ttbar->Add("/eos/user/a/anayak/HplusAnalysisRun2/idas/Output/cms-hcs-run2/CBA_trigSF/pre/2016/"+process+"_tree_"+sys+"_*");
