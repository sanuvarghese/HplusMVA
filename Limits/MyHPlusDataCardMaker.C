...
void MyHPlusDataCardMakerMini(TString inFileDir="/afs/cern.ch/work/s/savarghe/NewJEC/2018/mu/A/transformedHistos/ExcTight/mass160/", 
			      //TString syear="2018", 
			      ...
			      TString hPlusFileName="all_Hplus160.root")
{
  ...
  // Open data files
  TFile* fData = TFile::Open(inFileDir+"/hist_UltimDataMu1_2018_mu.root");
  ...
  // Open signal file
  TFile* fWH = TFile::Open(inFileDir+"/hist_HplusM160_2018_mu.root");
...
fout->cd();
wjet_bc_statUp->Write();                                                                                                               
wjet_bc_statDown->Write();                                                                                                             
wjet_fsrUp->Write();                                                                                                               
wjet_fsrDown->Write();  
wjet_isrUp->Write();
wjet_isrDown->Write();
...
// }
  ...
  out << "qcdrate_"<<channelName<<"_" << year << "_" << workingpoint << " rateParam * qcd 1.01 [0.0,10.0]" << endl;
...
void MyHPlusDataCardMaker(TString inFileDir="/afs/cern.ch/work/s/savarghe/NewJEC/2018/mu/A/transformedHistos/ExcTight/mass160/",
			    TString histSubDir_="KinFit",
			      TString histName="bdt_output",
			      TString channelName="mu",
			      int mass=160,
			      TString label="WH160",
			      TString hPlusFileName="hist_HplusM160_2018_mu.root")
{
