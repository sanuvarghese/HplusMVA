...
common_dir = "/afs/cern.ch/work/s/savarghe/private/NewJEC/Ntuple/controlD"
...
arguments = "{process} {filename_scenario} {argument_scenario} --channel {channel} --region {region}"
...
python3 RDataFrame.py "$file_name" "$3" "$4" "$5"
...
for process in processes:
    create_jdl(process, "base", "bc_stat_do")
