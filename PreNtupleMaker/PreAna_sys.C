void PreAna_sys(TString process, TString sys) {

  TFile *inputFilebase = TFile::Open("/eos/user/i/idas/Output/cms-hcs-run2/CBA_jecsyst/pre/2016/all/all_"+process+".root");
  //  TString sys = jecdown;                                                                                                                
  TString outputdir = "/eos/cms/store/group/phys_b2g/savarghe/NewJEC/2016/pre/pre_res/";
    
  //  TString outputdir = "/afs/cern.ch/user/s/savarghe/test3/CMSSW_12_3_0/src/HplusMVA/NtupleMaker/";
  auto wt_before = (TH1D*) inputFilebase->Get(process+"/"+sys+"/Iso/_wt_before_mu");

  auto wt_after = (TH1D*) inputFilebase->Get(process+"/"+sys+"/Iso/_wt_after_mu");
  ...
  TChain *ttbar= new TChain("Kinfit_Reco");
   ttbar->Add("/eos/cms/store/group/phys_b2g/idas/Output/cms-hcs-run2/Result/CBA_jecsyst/pre/2016/"+process+"_tree_"+sys+"_*");
  //  ttbar->Add("/eos/home-s/savarghe/Indra_Da/Output/cms-hcs-run2/CBA_elemva80/pre/2016/"+process+"_tree_"+sys+"_*");
...
//    TFile newfile("all_"+processName+".root", "recreate");
  ...
  readEvents(*ttbar,*wt_before ,*wt_after,process+"_"+sys);
