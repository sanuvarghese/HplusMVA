...
int KFQCDRBI(string signal = "DataMu", int year = 2018, string inpath_tree = "/eos/cms/store/group/phys_b2g/idas/Output/cms-hcs-run2/Result/CBA_metxycorr/2018")
{
 ...
 float Weight = 0.0, mjj = 0.0, CvsL_j2 = 0.0, CvsL_j1 = 0.0, CvsB_j1 = 0.0, CvsB_j2 = 0.0;
  ...
  tr->SetBranchAddress("CvsL_j2"        , &CvsL_j2);
  tr->SetBranchAddress("CvsL_j1"        , &CvsL_j1);
  tr->SetBranchAddress("CvsB_j1"        , &CvsB_j1);
  tr->SetBranchAddress("CvsB_j2"        , &CvsB_j2);
  tr->SetBranchAddress("pt_b1"          , &pt_b1);
  tr->SetBranchAddress("pt_j1"          , &pt_j1);
  tr->SetBranchAddress("pt_j2"          , &pt_j2);
  tr->SetBranchAddress("pt_b2"          , &pt_b2);
  tr->SetBranchAddress("dPhi_j1j2"      , &dPhi_j1j2);
  tr->SetBranchAddress("dPhi_j1b1"      , &dPhi_j1b1);
  tr->SetBranchAddress("CTopVar"        , &CTopVar);
  tr->SetBranchAddress("CvsL_b1"        , &CvsL_b1);
  tr->SetBranchAddress("CvsB_b1"        , &CvsB_b1);  
  tr->SetBranchAddress("CvsL_b2"        , &CvsL_b2);
  tr->SetBranchAddress("DelR_j1b2"      , &DelR_j1b2);
  tr->SetBranchAddress("ht_b1b2j1j2"    , &ht_b1b2j1j2);
  tr->SetBranchAddress("DelR_j2b1"      , &DelR_j2b1);
  tr->SetBranchAddress("dPhi_lb2"       , &dPhi_lb2);
  tr->SetBranchAddress("m_b1b2j1j2lv"   , &m_b1b2j1j2lv);
...
for (Long64_t i = 0; i < nentries; ++i) {
    ...
    // Check for NaN in BDT output and Weight
    if (std::isnan(value)) {
    ...
    // Fill the BDT output histogram
    bdt_output_hist->Fill(value, Weight);

    // Additional filling for exclusivity categories, e.g., ExcLoose
    if (value <= -0.24 || value > -0.02) {
  ...
  TH1D* bdt_output_hist = new TH1D("bdt_output", "Classifier Output", 30, 20, 170);
